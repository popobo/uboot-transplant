 ...
 */
#ifndef __MX6ULLEVK_ALIENTEK_EMMC_CONFIG_H
#define __MX6ULLEVK_ALIENTEK_EMMC_CONFIG_H
...
#define CONFIG_MII
#define CONFIG_FEC_ENET_DEV		1 /* 选择使用哪个网口 */

#if (CONFIG_FEC_ENET_DEV == 0)
#define IMX_FEC_BASE			ENET_BASE_ADDR
#define CONFIG_FEC_MXC_PHYADDR          0x2 /* ENET1的PHY芯片地址 */
#define CONFIG_FEC_XCV_TYPE             RMII
#elif (CONFIG_FEC_ENET_DEV == 1)
#define IMX_FEC_BASE			ENET2_BASE_ADDR
#define CONFIG_FEC_MXC_PHYADDR		0x1 /* ENET1的PHY芯片地址 */
#define CONFIG_FEC_XCV_TYPE		RMII
#endif
